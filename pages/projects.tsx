...
import { buymecoffee, mintDapp, venmoBlockchain, mintingDapp2 } from '../src/containers/projectData'

const About: NextPage = () => {
  return (
    <>
      <Head>
        <title>tal7aouy - Projects</title>
      ...
      <section className="max-w-5xl w-11/12 px-4 md:px-0 pt-24 md:pt-28 lg:pt-32 mx-auto md:w-3/4 lg:w-10/12 dark:text-gray-300">
        <div className="divide-y divide-gray-800">
          ...
          <div className="space-y-6 xl:space-y-10 ">
            <ProjectLayoutMed project={buymecoffee} />
            <ProjectLayoutMed project={mintDapp} />
            {/* 
            <ProjectLayoutMed project={venmoBlockchain} />
            <ProjectLayoutMed project={venmoBlockchain} /> */}
            <LeftProjectLayoutLarge project={buymecoffee} />
            <RightProjectLayoutLarge project={mintDapp} />
            <LeftProjectLayoutLarge project={venmoBlockchain} />

            <RightProjectLayoutLarge project={mintingDapp2} />
          </div>
        </div>
      </section>
    </>
