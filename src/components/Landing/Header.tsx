    ...
    <main className="flex flex-col space-y-12  divide-y divide-gray-200 mb-32 2xl:pt-28 ">
      <motion.div initial="initial" animate="animate">
        <motion.div variants={stagger}>
          ...
          >
            I&apos;m a Blockchain developer enthusiastic about blockchain and web3 industry, looking forward to learn
            something new every day and contribute to the industry!
          </motion.p>
          <motion.a
            variants={fadeInUp}
            target="_blank"
